            ...
            assetData.slice(0, assetData.length - 1).map((asset) => {
              return (
                <div className="my_asset_info">
                  <p className="d-flex flex-col text-white text-left">
                    <span className="w-full text-orange-600">Loyalty Token name: &nbsp;</span>
                    {` ${asset.asset_code}`}
                  </p>
                  <p className="d-flex flex-col text-white text-left">
                    <span className="w-full text-orange-600">Token Issuer:&nbsp;</span>{" "}
                    {` ${asset.asset_issuer.slice(
                      0,
                      10
                  ...
                  <div className="flex  justify-center text-center flex-col mt-11 md:text-2xl text-white" data-aos="fade-up">
                        <div className="mb-5  w-60 h-40 bg-black px-5 py-4 rounded-lg bg-glow-custom-2">
                        <h2 className="font-bold md:text-2xl px-2 py-2 text-orange-600 " data-aos="fade-up">Loyalty Points</h2>
                        <h2 className="font-bold md:text-2xl px-2 py-2 text-white  " data-aos="zoom-in" > {` ${(Number(asset.balance))*data.length}`}</h2>
...
if (!dataFetched)
  ...
  return (
    ...
    <btn
    href="#"
    className="bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 mx-3 rounded-md hover:from-orange-600 hover:to-orange-900 duration-300 text-white mb-4 cursor-pointer"

    onClick={handleConnect}
  >
    Connect to DIAMENTE Rewards
  </btn> 
  <btn
    href="#"
    className="py-3 px-4 mx-3  text-white mb-4 rounded-md border hover:bg-gray-900 hover:border-orange-500 duration-300  cursor-pointer"
    // data-aos="fade-left"
    // data-aos-offset="300"
  ...
  >
    ...
    <div className="w-max px-10 pt-8 pb-32 bg-black/99 text-white rounded-lg" id="navLinkcontainer">
    <div
